...
class GTProductDetail3D extends StatefulWidget {
  const GTProductDetail3D({super.key});
...
class _GTProductDetail3DState extends State<GTProductDetail3D> {
  ...
  void initState() {
    ...
    if (args == null || args is! Map<String, dynamic>) {
      throw Exception(
        'ProductDetail3D: arguments가 필요합니다. imageNames와 initialIndex를 전달해주세요.',
      );
    }
          ...
          Padding(
            ...
            child: Row(
              ...
              children: _colorList.asMap().entries.map((entry) {
                ...
                Color buttonColor = colorNameToColor(
                  color,
                ...
                return Padding(
                  padding: EdgeInsets.only(
                    right: index < _colorList.length - 1 ? 8 : 0,
                  ),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          ...
                          width: isSelected
                              ? 3.0
                              : 1.5, // 선택된 버튼: 두꺼운 테두리 (3px), 선택되지 않은 버튼: 얇은 테두리 (1.5px)
                        ),
                      ),
                    ),
                  ),
